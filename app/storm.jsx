...
import cscLogo from '../assets/images/STORM.png';
  ...
  useEffect(() => {
    const loadCategoriesAndProducts = async () => {
      try {
        ...
        const categories = await fetchCategoriesForCollege('storm');
        ...
        if (selectedFilter !== 'All') {
          ...
          const fetchedProducts = await fetchProducts('storm', categoryId);
          ...
          for (const category of categories) {
            const categoryProducts = await fetchProducts('storm', category);
            // Attach category to each product
