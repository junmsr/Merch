...
import cscLogo from '../assets/images/CHEM.png';
  ...
  useEffect(() => {
    const loadCategoriesAndProducts = async () => {
      try {
        ...
        const categories = await fetchCategoriesForCollege('chess');
        ...
        if (selectedFilter !== 'All') {
          ...
          const fetchedProducts = await fetchProducts('chess', categoryId);
          ...
          for (const category of categories) {
            const categoryProducts = await fetchProducts('chess', category);
            // Attach category to each product
